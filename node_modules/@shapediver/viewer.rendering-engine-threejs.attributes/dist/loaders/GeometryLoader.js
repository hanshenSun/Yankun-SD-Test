...
class GeometryLoader {
    ...
    init() { }
    load(geometry, parent, visualizationData) {
        var _a;
        ...
        if (geometry.primitive.mode === viewer_shared_types_1.PRIMITIVE_MODE.POINTS) {
            ...
            if (geometry.primitive.material && (geometry.primitive.material.opacity < 1 || geometry.primitive.material.alphaMap)) {
                ...
                if (side === viewer_shared_types_1.MATERIAL_SIDE.DOUBLE) {
                    geometry.primitive.material.side = viewer_shared_types_1.MATERIAL_SIDE.BACK;
                    ...
                    geometry.primitive.material.side = viewer_shared_types_1.MATERIAL_SIDE.FRONT;
                    meshes.push(new THREE.Mesh(bufferGeometry, this._renderingEngine.materialLoader.load(visualizationData, geometry.primitive.material, materialSettings)));
