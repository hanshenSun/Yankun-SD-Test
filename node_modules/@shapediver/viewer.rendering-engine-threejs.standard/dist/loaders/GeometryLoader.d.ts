...
import { GeometryData, PrimitiveData } from '@shapediver/viewer.shared.types';
...
export declare class GeometryLoader implements ILoader {
    ...
    init(): void;
    load(geometry: GeometryData, parent: SDObject): Box;
    loadGeometry(primitive: PrimitiveData): THREE.BufferGeometry;
